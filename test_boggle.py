...
class TestBoggle(unittest.TestCase):
    """
    Our test suite for boggle solcer
    """
    ...
    def test_grid_size_is_width_times_height(self):
        """
        Test is to ensure that the total size of the grid if equal to width times height
        """
    ...
    def test_grid_coordinates(self):
        """
        Test to emnsure that all the coordinates inside of the grid can be accessed
        """
    ...
    def test_all_grid_neighbours(self):
        ...
        for pos in grid:
            others = list(grid) #creates a new liost from the directory's keys
            others.remove(pos)
